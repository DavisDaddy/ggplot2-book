...
\CommentTok{#>  ui       X11                         }
\CommentTok{#>  language en_US                       }
\CommentTok{#>  collate  en_US.UTF-8                 }
\CommentTok{#>  tz       <NA>                        }
\CommentTok{#>  date     2016-02-07}
\CommentTok{#> Packages ------------------------------------------------------------}
\CommentTok{#>  package      * version  date       source        }
\CommentTok{#>  assertthat     0.1      2013-12-06 CRAN (R 3.2.1)}
\CommentTok{#>  BH             1.60.0-1 2015-12-28 CRAN (R 3.2.3)}
\CommentTok{#>  broom          0.4.0    2015-11-30 CRAN (R 3.2.3)}
\CommentTok{#>  colorspace     1.2-6    2015-03-11 CRAN (R 3.2.0)}
\CommentTok{#>  DBI            0.3.1    2014-09-24 CRAN (R 3.2.1)}
\CommentTok{#>  dichromat      2.0-0    2013-01-24 CRAN (R 3.2.0)}
\CommentTok{#>  digest         0.6.9    2016-01-08 CRAN (R 3.2.3)}
\CommentTok{#>  dplyr          0.4.3    2015-09-01 CRAN (R 3.2.2)}
...
\CommentTok{#>  lattice        0.20-33  2015-07-14 CRAN (R 3.2.1)}
\CommentTok{#>  lazyeval       0.1.10   2015-01-02 CRAN (R 3.2.1)}
\CommentTok{#>  magrittr       1.5      2014-11-22 CRAN (R 3.2.0)}
\CommentTok{#>  MASS           7.3-45   2015-11-10 CRAN (R 3.2.2)}
\CommentTok{#>  mnormt         1.5-3    2015-05-25 CRAN (R 3.2.2)}
\CommentTok{#>  munsell        0.4.2    2013-07-11 CRAN (R 3.2.0)}
\CommentTok{#>  nlme           3.1-124  2016-01-20 CRAN (R 3.2.3)}
\CommentTok{#>  plyr           1.8.3    2015-06-12 CRAN (R 3.2.1)}
\CommentTok{#>  psych          1.5.8    2015-08-30 CRAN (R 3.2.2)}
...
\CommentTok{#>  scales         0.3.0    2015-08-25 CRAN (R 3.2.2)}
\CommentTok{#>  stringi        1.0-1    2015-10-22 CRAN (R 3.2.2)}
\CommentTok{#>  stringr        1.0.0    2015-04-30 CRAN (R 3.2.0)}
\CommentTok{#>  tidyr          0.4.0    2016-01-18 CRAN (R 3.2.3)}
\end{Highlighting}
\end{Shaded}
